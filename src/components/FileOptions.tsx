...
const FileOptions = ({ file }: { file: File }) => {
  ...
  return (
    <div className="relative my-3 flex h-auto w-full items-center gap-6 rounded-md bg-neutral-800 px-2 py-4 md:w-[700px] md:justify-between md:px-5">
      ...
      <div className="flex w-full flex-col gap-3">
        <div className="flex flex-col gap-3 md:flex-row md:items-baseline">
          <p className="text-xl font-bold">
            {truncateString(file.name, 22, 22)}
          </p>
